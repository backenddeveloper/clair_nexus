...
#    clair.vm.network "private_network", ip: "192.168.33.11"
#    clair.vm.synced_folder "data/clair", "/data", type: "rsync", rsync__auto: true
#    clair.vm.provision "shell", inline: "/data/bootstrap.bash"
#  end
